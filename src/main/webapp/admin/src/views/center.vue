  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="会员积分" prop="huiyuanjifen">
          <el-input v-model="ruleForm.huiyuanjifen" readonly              placeholder="会员积分" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="会员优惠" prop="huiyuanyouhui">
          <el-input v-model="ruleForm.huiyuanyouhui" readonly              placeholder="会员优惠" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">

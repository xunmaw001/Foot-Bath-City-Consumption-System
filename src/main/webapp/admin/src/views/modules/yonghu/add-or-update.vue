    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="会员积分" prop="huiyuanjifen">
          <el-input v-model="ruleForm.huiyuanjifen" 
              placeholder="会员积分" clearable  :readonly="ro.huiyuanjifen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="会员积分" prop="huiyuanjifen">
              <el-input v-model="ruleForm.huiyuanjifen" 
                placeholder="会员积分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">

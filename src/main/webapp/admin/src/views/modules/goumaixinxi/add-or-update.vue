        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.goumaixiangqing" label="购买详情" prop="goumaixiangqing">
                    <span v-html="ruleForm.goumaixiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.goumaixiangqing = this.ruleForm.goumaixiangqing.replace(reg,'../../../ssmp4687/upload');
        } else {
          this.$message.error(data.msg);
        }
      });

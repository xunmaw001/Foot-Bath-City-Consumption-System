<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="技师号" prop="jishihao">
          <el-input v-model="ruleForm.jishihao" 
              placeholder="技师号" clearable  :readonly="ro.jishihao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="技师号" prop="jishihao">
              <el-input v-model="ruleForm.jishihao" 
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="技师性别" prop="jishixingbie">
          <el-select :disabled="ro.jishixingbie" v-model="ruleForm.jishixingbie" placeholder="请选择技师性别">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="技师性别" prop="jishixingbie">
	      <el-input v-model="ruleForm.jishixingbie"
                placeholder="技师性别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.jishitouxiang" label="技师头像" prop="jishitouxiang">
          <file-upload
          tip="点击上传技师头像"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.jishitouxiang?ruleForm.jishitouxiang:''"
          @change="jishitouxiangUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.jishitouxiang" label="技师头像" prop="jishitouxiang">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.jishitouxiang.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="技师简介" prop="jishijianjie">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jishijianjie" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jishijianjie" label="技师简介" prop="jishijianjie">
                    <span v-html="ruleForm.jishijianjie"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.jishijianjie = this.ruleForm.jishijianjie.replace(reg,'../../../ssmp4687/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.jishitouxiang!=null) {
		this.ruleForm.jishitouxiang = this.ruleForm.jishitouxiang.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    jishitouxiangUploadChange(fileUrls) {
	this.ruleForm.jishitouxiang = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{

<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="会员周期" prop="huiyuanzhouqi">
          <el-input v-model="ruleForm.huiyuanzhouqi" 
              placeholder="会员周期" clearable  :readonly="ro.huiyuanzhouqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="会员周期" prop="huiyuanzhouqi">
              <el-input v-model="ruleForm.huiyuanzhouqi" 

...
public class GoumaixinxiVO  implements Serializable {
	...
	private String goumaixiangqing;
	...
	public void setGoumaixiangqing(String goumaixiangqing) {
		this.goumaixiangqing = goumaixiangqing;
	}
	
	/**
	 * 获取：购买详情
	 */
	public String getGoumaixiangqing() {
		return goumaixiangqing;
	}
